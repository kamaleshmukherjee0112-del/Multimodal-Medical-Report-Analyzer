...
# ======================================================================
# 1. DETECT IMAGE TYPE (grayscale / colored)
# ======================================================================
...
# ======================================================================
# 2. SMART PREPROCESSOR (per-model formatting rules)
# ======================================================================
...
# ======================================================================
# 3. EfficientNet-B0 Binary Model Class
# ======================================================================
...
# ======================================================================
# 4. MAIN CLASS: Loads All 6 Models + Applies Decision Logic
# ======================================================================
class MedicalImageClassifier:
    ...
    def predict(self, image_path):
        ...
        # =================================================================
        # DECISION LOGIC (same as your Colab version)
        # =================================================================
        ...
        # 1️⃣ If any medical model is positive → choose highest confidence
        if medical_hits:
        ...
        # 2️⃣ Only Non-medical is positive
        if nonmedical_hit:
            return (
                "Non-Medical",
                nonmedical_hit,
        ...
        # 3️⃣ No positive predictions → fallback to highest confidence
