...
# ============================================================
# Background Image Setup (UNCHANGED – WORKING VERSION)
# ============================================================
...
set_background(
    r"C:\Users\KAMALESH MUKHERJEE\Desktop\Multimodal Medical Report Analyzer\src\bg_image.png"
)
...
st.title("Multimodal Medical Report Analyzer")
st.caption(
        ...
        if st.session_state.pipeline_done:
            ...
            if extracted_images:
                clf = MedicalImageClassifier(
                    r"C:\Users\KAMALESH MUKHERJEE\Desktop\Multimodal Medical Report Analyzer\image_classification_model"
                )
